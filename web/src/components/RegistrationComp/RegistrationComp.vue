...
.registration-container {
  ...
  .valid { color: #4CAF50; &::before { content: "✔ "; } }
  .invalid { color: #f44336; &::before { content: "✖ "; } }
  .invalid-text { color: #f44336; font-size: 0.85rem; margin-top: 0.25rem; }
  ...
  .submit button {
    width: 100%; padding: 1rem; background: #4CAF50; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 1.1rem;
